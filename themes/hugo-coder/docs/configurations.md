...
| favicon_32                    | string | No       | Custom path to a 32x32 favicon.                  | `"/img/mfm_icon_32x32.ico"`       | `"/img/mfm_icon_32x32.ico"`                       |
| favicon_16                    | string | No       | Custom path to a 16x16 favicon.                  | `"/img/mfm_icon_16x16.ico"`       | `"/img/mfm_icon_16x16.ico"`                       |
...
[params]
  ...
  favicon_32 = "/img/mfm_icon_32x32.ico"
  favicon_16 = "/img/mfm_icon_16x16.ico"
